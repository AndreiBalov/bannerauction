...
public:
        ...
        const uint32_t slotsCount, FType filterArg, FFunc filterFunction/*std::function<bool(const Banner*, FType)>*/)
    {
        ...
        // дл¤ группировки по ценам и сортировки
        ...
        std::set<int> idCheck; // дл¤ соблюдени¤ уникальности id 
    ...
    /*!
    * ‘ильтр по странам
    * /brief ƒл¤ добавлени¤ фильтра по другом упараметру перегрузите эту функцию с другим вторым параметром
    */
